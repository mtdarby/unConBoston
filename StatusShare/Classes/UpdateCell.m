...
@synthesize nameLabel, textLabel, timeLabel, avatar, pinView;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(8., 8., 100, 16.)];
        ...
        textLabel = [[UILabel alloc] initWithFrame:CGRectMake(8., CGRectGetMaxY(nameLabel.frame), 100., 20.)];
...
//    self.nameLabel.text = update.leader;
    self.textLabel.text = update.leader;
